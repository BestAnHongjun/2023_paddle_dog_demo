...
USE_LITE_KERNEL(dequantize_log, kARM, kInt8, kNCHW, def);
...
USE_LITE_KERNEL(lookup_table_v2, kARM, kAny, kNCHW, int8_int64);
USE_LITE_KERNEL(lookup_table_v2, kARM, kAny, kNCHW, int8_int32);
USE_LITE_KERNEL(lookup_table, kARM, kAny, kNCHW, float_int32);
USE_LITE_KERNEL(lookup_table_v2, kARM, kAny, kNCHW, float_int32);
